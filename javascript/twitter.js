    ...
    $.ajax({
        ...
        success: function(json_results){
            ...
            $.each(json_results, function(key) {
                ...
                html += '<div class="x-tweetanchor"></div><div class="tweet-bubble"><div class="tweet-content"><h2>'+json_results[key].user.name+'</h2><p><strong>'+json_results[key].text+'</strong></p>';
